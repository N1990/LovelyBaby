 ...
 */
public class ReplayDetailListModel implements Parcelable {
    ...
    public ReplayDetailListModel() {
    }

    protected ReplayDetailListModel(Parcel in) {
        this.data = in.readParcelable(DataEntity.class.getClassLoader());
        this.msg = in.readString();
    }

    public static final Parcelable.Creator<ReplayDetailListModel> CREATOR = new Parcelable.Creator<ReplayDetailListModel>() {
        public ReplayDetailListModel createFromParcel(Parcel source) {
            return new ReplayDetailListModel(source);
        }

        public ReplayDetailListModel[] newArray(int size) {
            return new ReplayDetailListModel[size];
        }
    };
}
