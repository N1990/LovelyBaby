 ...
 */
public class ReplayDetailModel implements Parcelable {
    ...
    public ReplayDetailModel() {
    }

    protected ReplayDetailModel(Parcel in) {
        this.data = in.readParcelable(DataEntity.class.getClassLoader());
        this.msg = in.readString();
    }

    public static final Parcelable.Creator<ReplayDetailModel> CREATOR = new Parcelable.Creator<ReplayDetailModel>() {
        public ReplayDetailModel createFromParcel(Parcel source) {
            return new ReplayDetailModel(source);
        }

        public ReplayDetailModel[] newArray(int size) {
            return new ReplayDetailModel[size];
        }
    };
}
