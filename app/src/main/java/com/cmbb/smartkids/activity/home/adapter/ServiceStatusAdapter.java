 ...
 */
public class ServiceStatusAdapter extends NiceSpinnerBaseAdapter {

    private List<ServiceSortModel.DataEntity.ServiceStatusEntity> data;
    ...
    public void setData(List<ServiceSortModel.DataEntity.ServiceStatusEntity> data){
        if(data != null){
            this.data = data;
        }else{
    ...
    public List<ServiceSortModel.DataEntity.ServiceStatusEntity> getData(){
        return this.data;
    }
