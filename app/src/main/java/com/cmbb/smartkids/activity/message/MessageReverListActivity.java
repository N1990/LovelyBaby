 ...
 */
public class MessageReverListActivity extends BaseActivity implements View.OnClickListener, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {
    private static final String TAG = MessageReverListActivity.class.getSimpleName();
    ...
    private void initRecyclerView() {
        ...
        adapter = new MsgReverAdapter(this);
    ...
    public void onItemClick(int position) {
        CommunityDetailActivity.newInstance(this, Integer.valueOf(adapter.getItem(position).getRelateField()));
    }
    ...
    public static void newInstance(BaseActivity context, MessageCountModel.DataEntity dataEntity) {
        Intent intent = new Intent(context, MessageReverListActivity.class);
