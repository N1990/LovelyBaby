 ...
 * 类描述：
 * 创建人：javon
 * 创建时间：2015/9/14 16:37
 */
public class UnConsumeOrderFragment extends BaseFragment {
    private final String TAG = AllOrderFragment.class.getSimpleName();
    private final int HANDLER_ORDER_REQUEST = 11113;
    ...
    private void addListener(){
        ...
        adapter.setOnHandlerListener(onHandleListener);
    }
    ...
    private CustomListener.ItemClickListener onHandleListener = new CustomListener.ItemClickListener() {
        @Override
        public void onItemClick(View v, int position, Object object) {
            OrderListModel.DataEntity.RowsEntity itemData = (OrderListModel.DataEntity.RowsEntity) object;
