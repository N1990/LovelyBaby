 ...
 * 创建时间：2015/9/8 13:17
 */
public class MyCarePopmanFragment extends BaseFragment implements View.OnClickListener, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {
    private final String TAG = MyCarePopmanFragment.class.getSimpleName();
    private final int USER_CENTER_REQUEST = 1100;
    ...
    public void onLoadMore() {
        pager++;
        FriendListModel.getFriendListRequest(1, pager, pagerSize, BaseApplication.token, new OkHttpClientManager.ResultCallback<FriendListModel>() {
            @Override
