 ...
 * 创建时间：2015/9/8 13:20
 */
public class MySystemMessageFragement extends BaseFragment implements View.OnClickListener, RecyclerArrayAdapter.OnLoadMoreListener, SwipeRefreshLayout.OnRefreshListener, RecyclerArrayAdapter.OnItemClickListener {
    private final String TAG = MySystemMessageFragement.class.getSimpleName();
...
//                        service.putExtra("serviceId", relationId);
