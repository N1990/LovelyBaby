...
public class MyCommunityHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void setData(TopicListModel.DataEntity.RowsEntity data, MyCommunityAdapter adapter, int position) {
        ...
        tvType.setText(data.getTopicType());
        ...
        if (data.getTopicImgList() != null && data.getTopicImgList().size() >= 3) {
            ...
            FrescoTool.loadImage(iv1, data.getTopicImgList().get(0).getImg(), TDevice.dip2px(100, iv1.getContext()) + "");
            FrescoTool.loadImage(iv2, data.getTopicImgList().get(1).getImg(), TDevice.dip2px(100, iv2.getContext()) + "");
            FrescoTool.loadImage(iv3, data.getTopicImgList().get(2).getImg(), TDevice.dip2px(100, iv3.getContext()) + "");
