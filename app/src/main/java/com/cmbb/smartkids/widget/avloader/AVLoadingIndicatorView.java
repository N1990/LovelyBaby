package com.cmbb.smartkids.widget.avloader;
...
public class AVLoadingIndicatorView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicator_color, getResources().getColor(R.color.primaryColor));
        a.recycle();
        mPaint = new Paint();
